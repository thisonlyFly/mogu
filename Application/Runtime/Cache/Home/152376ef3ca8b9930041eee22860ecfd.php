...
<div class="header header-bottom">
    ...
    <script>
        var Details_ajax_url="/mogu/index.php/Home/Details";
        var shopping_Addcart="<?php echo U('ShoppingCart/addCart');?>";
        ...
        <div class="commodity_details_body_wrap_primary">
            <div class="commodity_details_body_wrap_primary_goods">
                <div class="fl goods_topimg">
                    <div class="big_img">
                        <img src="/mogu/Public/<?php echo ($goods_info['goods_img1']); ?>" id="big_images">
                    </div>
                    <div class="four_small_img">
                        <div class="four_s_i_center">
                            <div class="list">
                                <ul class="four_s_i_center_ul">
                                    <?php if($goods_info['goods_img2'] != ''): ?><li><img id="btn1" src="/mogu/Public/<?php echo ($goods_info['goods_img1']); ?>"><i class="four_ul_line"></i></li>
                                        <li><img id="btn2" src="/mogu/Public/<?php echo ($goods_info['goods_img2']); ?>"><i class="four_ul_line"></i></li><?php endif; ?>
                                    <?php if($goods_info['goods_img3'] != ''): ?><li><img id="btn3" src="/mogu/Public/<?php echo ($goods_info['goods_img3']); ?>"><i class="four_ul_line"></i></li><?php endif; ?>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="fl commodity_details_body_wrap_goods_info">
                    <div class="info_box">
                        <h1 class="goods_title">
                            <span itemprop="name"><?php echo ($goods_info['goods_title']); ?></span>
                        </h1>
                        <div class="goods_prowrap">
                            <div class="goods_prowrap_box">
                                <span class="goods_prowrap_price">价格：</span>
                                <div class="property_cont">
                                    <span>¥<?php echo ($goods_info['goods_oldprice']); ?></span>
                                </div>
                            </div>
                            <div class="goods_prowrap_box">
                                <span class="property_type_now">促销价：</span>
                                <div class="property_cont_now fl">
                                    <span id="J_NowPrice" class="property_cont_now_price">¥<?php echo ($goods_info['goods_price']); ?></span>
                                </div>
                            ...
                            <div class="goods_sku_xz_content">
                                <dl style="height: 42px;">
                                    ...
                                    <dd class="num">
                                        ...
                                        <div class="goods_sku_stock fl">库存<?php echo $goods_info['goods_maxnum']-$goods_info['goods_salenum'] ?>件</div>
                                    </dd>
                                </dl>
                            </div>
                            <div class="commodity_details_goods_buy">
                                <a href="http://localhost/mogu/Home/ConfirmOrder/index.html" class="fl mr10 buy_btn_now" onclick="buy()">立刻购买</a>
                                <a href="javascript:;" class="fl mr10 buy_cart buy_btn_now" onclick="addCart()">加入购物车</a>
                            </div>
                            <script>
                            </script>
                            <input type="hidden" id="goods_id" value="<?php echo ($goods_info['goods_id']); ?>">
                        </div>
